...
$$
p = (b_1, b_2, \dots, b_k), \quad b_i \in \Sigma^{+}.
$$
...
We equip \(N^{-1}\) with the **standard discrete topology**:
...
This is the simplest adjacency compatible with degree.
...
- moves are not reversible (see Section 6)
...
$$
5 \preceq^{-1} 6, \qquad 6 \preceq^{-1} 5.
$$
